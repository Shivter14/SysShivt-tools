...
call %1
:startc
if not defined sst.window.height set sst.window.height=13
if not defined sst.window.width set sst.window.width=48
if not defined sst.window.boxX set /a sst.window.boxX=%sst.defaultresX%/2-(%sst.window.width%/2-1)
if not defined sst.window.boxY set /a sst.window.boxY=%sst.defaultresY%/2-(%sst.window.height%/2)
if not defined sst.window.lines set /a sst.window.lines=%sst.window.height%-2 
for /l %%a in (1 1 %sst.window.lines%) do set /a sst.window.lineY%%a=%sst.window.boxY%+%%a
if not defined sst.window.TIcolor set sst.window.TIcolor=8
if not defined sst.window.FGcolor set sst.window.FGcolor=0
if not defined sst.window.BGcolor set sst.window.BGcolor=7
if not defined sst.window.TTcolor set sst.window.TTcolor=f
set /a sst.window.line=%sst.window.boxX%+2
set /a sst.window.cnbX=%sst.window.boxX%+%sst.window.width%-6
set /a sst.window.cxbX=%sst.window.boxX%+%sst.window.width%-3
set /a sst.window.cxbY=%sst.window.boxX%+%sst.window.width%-1
set /a sst.window.cnbX=%sst.window.boxX%+%sst.window.width%-6
set /a sst.window.cnbY=%sst.window.boxX%+%sst.window.width%-3
set /a sst.window.conb=%sst.window.boxX%+%sst.window.width%-6
set /a sst.window.crpo=%sst.window.boxY%+%sst.window.height%-2
set /a sst.window.giml=%sst.window.width%-4
